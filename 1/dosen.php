    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        <li class="active"><a href="dosen.php"><i class="fa fa-user"></i><span>Pengajar</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-user"></i> Pengajar</li>
          </ol>
        </section>
							...
							<div class="form-group">
								<label>Pengajar</label>
									<div class="input-group">
										...
										<input name="namadosen" type="text" class="form-control" placeholder="Nama Pengajar"/>
									</div>
							</div>
							<div class="form-group">
								<label>Tanggal Lahir</label>
									<div class="input-group">
										...
										<input id="tanggallahir" name="tanggallahir" type="text" class="form-control" placeholder="Tanggal Lahir">
									</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>No. Telp</label>
									<div class="input-group">
										...
										<input name="nomortelp" type="text" class="form-control" placeholder="No Telpon"/>
									</div>
							</div>
							<div class="form-group">
								<label>Topik Pelatihan</label>
									<div class="input-group">
										...
										<input name="topikpelatihan" type="text" class="form-control" placeholder="Topik Pelatihan"/>
									</div>
							</div>
